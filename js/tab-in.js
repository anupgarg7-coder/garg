...
function setInType(t){
  ...
  } catch(e) { console.warn('[in:setInType] error:', e); }
}
...
function renderAddedItems(){
  ...
  } catch(e) { console.warn('[in:renderAddedItems] error:', e); }
}
...
function saveInput(mode){
  ...
  } catch(e) { console.warn('[in:saveInput] error:', e); }
}
...
function renderInputList(){
  ...
  } catch(e) { console.warn('[in:renderInputList] error:', e); }
}