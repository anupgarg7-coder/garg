...
function renderProcessTracker() {
  try {
    ...
    renderProcessTags();
  } catch(e) { console.warn('[process:renderProcessTracker] error:', e); }
}
...
function renderProcessSection(elId,challans,stage) {
  ...
  } catch(e) { console.warn('[process:renderProcessSection] error:', e); }
}
...
function markProcessReturn(id,returnType) {
  ...
  } catch(e) { console.warn('[process:markProcessReturn] error:', e); }
}
...
function markDekaReturn(id) {
  ...
  } catch(e) { console.warn('[process:markDekaReturn] error:', e); }
}
...
function renderProcessTags() {
  try {
    ...
    updateProcessSelect();
  } catch(e) { console.warn('[process:renderProcessTags] error:', e); }
}
...
function updateProcessSelect() {
  ...
  } catch(e) { console.warn('[process:updateProcessSelect] error:', e); }
}
...
function addProcessType() {
  ...
  } catch(e) { console.warn('[process:addProcessType] error:', e); }
}
...
function deleteProcessType(name) {
  ...
  } catch(e) { console.warn('[process:deleteProcessType] error:', e); }
}
...
function toggleProcessManager() {
  ...
  } catch(e) { console.warn('[process:toggleProcessManager] error:', e); }
}