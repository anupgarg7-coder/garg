...
function makeShelfRow(shelfNo='', qty=0, container) {
  ...
  } catch(e) { console.warn('[stock:makeShelfRow] error:', e); }
}
...
function makeStockRow(name='', preStockWarehouse=0, preStockShop=0, lowWarn=0, shelves=[], preStockDate='') {
  ...
  } catch(e) { console.warn('[stock:makeStockRow] error:', e); }
}
...
function editStockItem(name){
  ...
  } catch(e) { console.warn('[stock:editStockItem] error:', e); }
}
...
function renderStockInputRows(){
  ...
  } catch(e) { console.warn('[stock:renderStockInputRows] error:', e); }
}
...
function saveStockItems(){
  ...
  } catch(e) { console.warn('[stock:saveStockItems] error:', e); }
}
...
function getLatestPreStockDate(name){
  ...
  } catch(e) { console.warn('[stock:getLatestPreStockDate] error:', e); }
}
...
function getWhInQty(n){
  try {
    ...
    return tot;
  } catch(e) { console.warn('[stock:getWhInQty] error:', e); }
}
...
function getShOutQty(n){
  try {
    ...
    return tot;
  } catch(e) { console.warn('[stock:getShOutQty] error:', e); }
}
...
function getShInDeduction(n){
  try {
    ...
    return tot;
  } catch(e) { console.warn('[stock:getShInDeduction] error:', e); }
}
...
function getSalesQtyForItem(n){
  try {
    ...
    return tot;
  } catch(e) { console.warn('[stock:getSalesQtyForItem] error:', e); }
}
...
function renderShelfBadges(item) {
  ...
  } catch(e) { console.warn('[stock:renderShelfBadges] error:', e); }
}
...
function renderStockRegister(){
  ...
  } catch(e) { console.warn('[stock:renderStockRegister] error:', e); }
}
...
function seedItemCatalog() {
  try {
    ...
    save();
  } catch(e) { console.warn('[stock:seedItemCatalog] error:', e); }
}
...
function getAllKnownItemNames() {
  ...
  } catch(e) { console.warn('[stock:getAllKnownItemNames] error:', e); }
}
...
function getAllItemNames(){
  ...
  } catch(e) { console.warn('[stock:getAllItemNames] error:', e); }
}
...
function getItemQty(name){
  ...
  } catch(e) { console.warn('[stock:getItemQty] error:', e); }
}
...
function forceSeed(){
  try {
    ...
    renderStockRegister();
  } catch(e) { console.warn('[stock:forceSeed] error:', e); }
}